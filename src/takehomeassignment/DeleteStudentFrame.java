...
public class DeleteStudentFrame extends javax.swing.JFrame {
    ...
    DBOperation dbOpsD = new DBOperation();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 470, 530));
        ...
        jPanel2.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 650, 90, 30));
        ...
        setSize(new java.awt.Dimension(509, 691));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(dbOpsD.deleteStudent(this.st)){
            switch (CourseType) {
                case "Undergraduate Student":
                    dbOpsD.deleteUndergraduteStudent(this.st);
                    System.out.println("Uuuuuuuuuu");
                    JOptionPane.showMessageDialog(this, "Successfully Deleted !!");
                    this.dispose();
                    break;
                case "Postgraduate Student":
                    dbOpsD.deletePostgraduateStudent(this.st);
