 ...
 * @author Acer
 */
public class DeleteInstructorFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DeleteInstructorFrame
     */
    public DeleteInstructorFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Instucter");
        ...
        setSize(new java.awt.Dimension(499, 641));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (dbOps.deleteInstructor(this.i)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteInstructorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteInstructorFrame().setVisible(true);
            }
        });
    }
