 ...
 * @author Acer
 */
public class UpdatePostgraduateStudentFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UpdatePostgraduateStudentFrame
     */
    public UpdatePostgraduateStudentFrame() {
        initComponents();
    }
    ...
    void setFields(PostgraduateStudent pstudent){
        ...
        txtYearOFCompletion.setText(pstudent.getFaculty());
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Update Postgraduate Student");
        ...
        setSize(new java.awt.Dimension(425, 396));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        boolean result = dbOpsP.updatePostgraduateStudent(ps);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdatePostgraduateStudentFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdatePostgraduateStudentFrame().setVisible(true);
            }
        });
    }
